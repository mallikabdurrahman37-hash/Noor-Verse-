...
async function showTranslation() {
  ...
  try {
    ...
    slice.forEach((a, i) => {
      ...
      html += `<div class="translation-item"><div class="translation-ayah-num">Ayah ${ayahNum}</div><div class="translation-text" dir="${dir}">${a.text}</div></div>`;
    });
...
function init() {
  populateReciters();
  // Bootstrap history so back button never exits the PWA immediately
